...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      {/* Featured Fleet Machinery Showcase */}
        ...
        <div className="container mx-auto px-4 max-w-7xl space-y-12">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-black tracking-tight">Verified Heavy Machinery Showcase</h2>
      ...
      <section className="py-16 container mx-auto px-4 max-w-7xl space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <h2 className="text-3xl md:text-4xl font-black tracking-tight">Enterprise Infrastructure & Telematics</h2>
          <p className="text-sm text-muted-foreground">
      ...
      <section className="py-16 bg-slate-950 text-white border-t border-amber-500/20">
        <div className="container mx-auto px-4 max-w-4xl text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            ...
            <Button variant="outline" asChild size="lg" className="w-full sm:w-auto font-bold border-slate-700 text-white hover:bg-slate-800">
