...
export default function TelematicsPage() {
  ...
  const activeMachines = [
    {
      ...
      owner: "Surat Yard #4",
      jobsite: "Surat Industrial Highway, GJ",
      status: "OPERATIONAL",
      rpm: 1850,
      oilTemp: "88°C",
      fuelLevel: "74%",
    ...
    },
    {
      ...
      owner: "Delhi NCR Hub",
      jobsite: "Gurugram Expressway, HR",
      status: "IDLE_STANDBY",
      rpm: 800,
      oilTemp: "75°C",
      fuelLevel: "62%",
  ...
  const currentMachine = activeMachines.find((m) => m.id === selectedMachineId) || activeMachines[0];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-7xl space-y-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-card p-4 rounded-2xl border shadow-sm">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">3 Active Jobsite Sensors Transmitting Data</p>
            </div>
          </div>
        ...
        {/* Interactive Telematics Dashboard */}
              ...
              {activeMachines.map((machine) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-extrabold text-sm">{machine.name}</span>
                    <Badge
                      className={
                  ...
                  <p className="text-xs text-muted-foreground mt-1 flex items-center">
                    <MapPin className="w-3 h-3 mr-1 text-primary" /> {machine.jobsite}
                  </p>
                ...
                <div className="h-64 rounded-2xl bg-gradient-to-tr from-slate-950 via-slate-900 to-slate-950 border border-slate-800 relative flex items-center justify-center p-6 text-center text-white overflow-hidden shadow-inner">
                  ...
                  <div className="relative z-10 space-y-3 max-w-md">
                    ...
                    <p className="text-xs text-slate-300">
                      Coordinates: 21.1702° N, 72.8311° E (Surat Industrial Zone) • Geofence Radius: 5.0 km
                    </p>
